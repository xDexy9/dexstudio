...
import { getUnreadMessageCount } from '@/services/firestoreService';
          ...
          <div className="flex items-center gap-2.5">
            ...
            {!isCollapsed && (
              <div>
                ...
                <p className="text-[10px] text-muted-foreground font-medium">{t('sidebar.officeTitle')}</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-2 p-3 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-lg border border-primary/20 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-white/70 font-medium capitalize mt-0.5">{user.role.replace('_', ' ')}</p>
              </div>
            </div>
          </div>
        )}
